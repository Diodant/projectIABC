...
function AboutUs() {
  ...
  return (
    ...
    <div className="page-wrapper">
        ...
        <p className="page-text">Членами Международной Ассоциации Профессионалов Индустрии Красоты и Ухода могут стать только лица, которые продемонстрировали выдающиеся достижения в своей профессиональной деятельности.</p>
