...
function Certificate() {
  ...
  return (
    <div>
    <Helmet>
        <title>Сертификат Ассоциации IABC</title>
        <meta
        name="description"
    ...
    <div className="text-center">
        <div className="page-title">Сертификат</div>
        <div className="awards-title">“Международный Сертификат за заслуги в индустрии красоты”</div>
        </div>
        <div className='certificate-img'><img src={CertificateImg} alt="Certificate" /></div>
        ...
        <p className="page-text">Вручение сертификатов происходит ежегодно и награждаются только два самых выдающихся мастеров красоты в год. Это подчеркивает, что только наиболее выдающиеся вклады и достижения будут отмечены, и каждый лауреат может быть уверен, что его или ее работа действительно имеет особое значение.</p>
        <p className="page-text">Кандидаты на получение сертификата проходят тщательный отбор на основе их профессиональных достижений, включая инновационные подходы, успешное внедрение новых техник, практические результаты, влияние на отрасль и уровень профессионализма.</p>
        <p className="page-text">Церемония вручения сертификатов является важным событием, собирающим ведущих мастеров красоты из всех уголков СНГ, способствуя обмену опытом и знаниями между различными странами и культурами.</p>
        <p className="page-text">Сертификт "За заслуги в индустрии красоты" выделяет не только личные достижения, но и вклад лауреатов в развитие и процветание индустрии красоты на международном уровне, что имеет далеко идущие положительные последствия для экономики и культуры в целом.</p>
    </div>
    </div>
  );
}
