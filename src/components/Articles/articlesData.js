...
import ArticleImg20 from '../../img/ArticleImg/Article20.png'
import ArticleImg20_2 from '../../img/ArticleImg/Article20_2.png'
import ArticleImg20_3 from '../../img/ArticleImg/Article20_3.png'
import ArticleImg21 from '../../img/ArticleImg/Article21.png'
...
const articlesData = [
    ...
    {
        slug: 'article20',
        author: 'Анастасия Жукова',
        date: '2022-12-15',
        title: "Блеск и Престиж: Итоги Международной Премии 'Олимп Красоты' 2022",
        summary: 'Международная Премия "Олимп красоты" 2022 года официально завершилась',
        imageUrl: ArticleImg20,
        imageUrl2: ArticleImg20_2,
        imageUrl3: ArticleImg20_3,
        content1: 'Международная Премия "Олимп красоты" 2022 года официально завершилась, подтвердив свой статус одного из самых престижных событий в мире индустрии красоты и эстетической медицины. В этом году участие приняли более 450 профессионалов из 12 стран, включая Россию, ОАЭ, Казахстан, Беларусь, Молдову и Великобританию, Испанию, Болгарию, Черногорию, Францию и другие. Ежегодно премия объединяет лучших специалистов со всего мира, которые демонстрируют передовые инновации и высочайшее мастерство в своей области. Получение этой награды является доказательством международного признания и профессионального успеха, что открывает новые горизонты для победителей и членов жюри на глобальной арене.',
        content2: 'Ежегодная премия проходит с 1 октября по 1 декабря 2022 года, и в течение этого времени лучшие мастера демонстрируют свои инновационные достижения и выдающиеся навыки.',
        content3: 'Церемония награждения, проходящая 10 декабря 2022 года стала кульминацией престижной премии, где профессионалы со всего мира получили признание за свои выдающиеся достижения. Получение премии "Олимп красоты" — это не просто награда, а символ международного признания, который открывает перед лауреатами новые профессиональные горизонты.',
        content4: '"Олимп красоты" — это символ высочайшего признания и достижений в индустрии красоты и эстетической медицины. Учреждённая Международной Ассоциацией Красоты и Ухода в 2019 году, она ежегодно привлекает выдающихся профессионалов со всего мира. Победители премии представляют собой не только мастеров с безупречными навыками, но и новаторов, чьи разработки и вклад в развитие индустрии признаны на международном уровне.',
        content5: 'В этом году победителями премии стали:',
        content6: 'Категория «Мастер ногтевого сервиса»:',
        textli1:'Инновации в процедурах — Елизавета Лютер (Молдова)',
        textli2:'Прорыв года — Дарья Письменная (Россия)',
        content7: 'Категория «Парикмахер»:',
        textli3:'Инновации в процедурах — Анна Ширяева (Украина)',
        textli4:'Прорыв года — Дарья Евстратова (Казахстан)',
        content8: 'Категория «Make-up артисты»:',
        textli5:'Инновации в процедурах — Наталья Васильева (Россия)',
        textli6:'Прорыв года — Алина Жукова (Казахстан)',
        content9: 'Категория «Косметолог»:',
        textli7:'Инновации в процедурах — Настя Камыш (Беларусь)',
        textli8:'Прорыв года — Екатерина Тепло (Украина)',
        content10: 'Категория «Мастер перманентного макияжа»:',
         textli9:'Инновации в процедурах — Екатерина Бойко (Украина)',
        textli10:'Прорыв года — Ксения Квитченко (Украина)',
        content11: 'Категория «Тату мастер»:',
        textli11:'Инновации в процедурах — София Андрющенко (Молдова)',
        textli12:'Прорыв года — Юлия Проскурина (Беларусь)',
        content12: 'Эти победители — профессионалы, чьи работы выделяются инновационностью, мастерством и высоким качеством. Их достижения вдохновляют на развитие всей индустрии красоты, а признание в рамках этой премии открывает перед ними двери к новым возможностям на международной арене.',
        content13: 'Каждый из этих специалистов внес уникальный вклад в развитие индустрии красоты, что позволило им заслужить признание как на национальном, так и на международном уровнях. Получение премии "Олимп красоты" подтверждает их статус как лидеров отрасли, готовых к новым достижениям и участию в глобальных проектах.',
        content14: 'Неотъемлемой частью престижности премии является профессионализм и международное признание членов жюри, которые отбираются среди лучших экспертов в области красоты и эстетической медицины.',
        content15: 'Для членов жюри участие в отборе лучших — это не только огромная честь, но и подтверждение их статуса в качестве лидеров индустрии. Каждый судья обладает неоспоримым авторитетом и международным опытом, что делает их решения бесценными для признания победителей.',
        content16: 'В состав жюри 2022 года вошли выдающиеся профессионалы с мировым именем:',
        content17: 'Категория «Парикмахеры и стилисты»:',
        textli13:'Вячеслав Дюденко (Украина) — Председатель правления КССК, судья международного класса, владелец сети салонов "D2", фешн-директор школы профессионального мастерства парикмахеров.',
        textli14:'Елена Глазкова (Украина) — Международный инструктор KODI PROFESSIONAL, стилист с более чем 30-летним опытом, тренер украинской команды на международных соревнованиях.',
        textli15:'Ольга Глушенкова (Украина) — Международный мастер с опытом работы в области визажа и перманентного макияжа более 13 лет, инструктор и преподаватель.',
        content18: 'Категория «Make-up артисты»:',
        textli16:'Лейла Гаджиева (Казахстан) — Директор по визажу сети салонов Persona Lab, автор инновационных методик макияжа, участник международных выставок и семинаров.',
        textli17:'Елена Юдина (Украина) — Основатель VISART academy, мастер международного класса, чемпион мира по макияжу, тренер международных конкурсов.',
        textli18:'Jabe (Великобритания) — Визажист с работами для Gucci, Kenzo, Nina Ricci, консультант по цвету для крупнейших косметических компаний.',
        content19: 'Категория «Мастера ногтевого сервиса»:',
        textli19:'Галина Гриб (Украина) — Fashion иллюстратор и дизайнер с более чем 20-летним опытом, победитель международных конкурсов.',
        textli20:'Ольга Глушенкова (Украина) — Преподаватель и мастер международного класса.',
        textli21:'Анна Адамовская (Украина) — Судья международных чемпионатов по ногтевой эстетике, ведущий технолог компании KODI PROFESSIONAL.',
        content20: 'Категория «Косметологи и эстетисты»:',
        textli22:'Татьяна Козарь (Россия) — Основатель бренда CozarSkin Cosmetics, победитель конкурса GiGi, эксперт в области химико-технологической косметологии.',
        textli23:'Ирина Турухина (Украина) — Бренд-менеджер центра LACRIMA, автор онлайн-курсов по омоложению и депиляции.',
        textli24:'Алина Никодимова (Россия) — Косметолог и преподаватель, победитель Всероссийских конкурсов по эстетической косметологии.',
        content21: 'Категория «Мастера перманентного макияжа»:',
        textli25:'Елена Иванова (Россия) — Мастер с опытом более 15 лет, автор техники "Natural look", судья международных конкурсов.',
        textli26:'Алексей Васильев (Украина) — Чемпион Украины и призер международных конкурсов по макияжу.',
        textli27:'Юлия Михайлова (Украина) — Основатель студии Triumf school, призер международных чемпионатов по визажу.',
        content22: 'Категория «Тату мастера»:',
        textli28:'Артемий Неумоин (Россия) — Мастер японского стиля татуировок с опытом более 15 лет.',
        textli29:'Бэн Клишевский (Украина) — Основоположник направления "космический реализм", владелец студии Banana tattoo.',
        textli30:'Егор Немшевич (Украина) — Специалист по орнаменталу, спикер международных выставок и форумов по тату.',
        content23: 'Эти эксперты не только оценивают работы участников, но и задают высокие стандарты для всей индустрии. Участие в жюри премии "Олимп красоты" — это знак высшего профессионализма и признания на международной арене.',
        content24: 'Престиж участия в жюри этой премии не уступает престижу победы. Каждый член жюри обладает выдающимися достижениями, международным опытом и является признанным лидером в своей области. Их профессиональная репутация и опыт делают выбор победителей не только честным и объективным, но и крайне значимым для всей индустрии. Быть членом жюри "Олимп красоты" — это знак высочайшего профессионального уровня, доверия и уважения в мировом сообществе красоты.',
        content25: 'Премия "Олимп красоты" это глобальное признание достижений специалистов, которые вносят вклад в развитие мировой индустрии красоты. Получение этой премии не только подчеркивает мастерство и креативность лауреатов, но и укрепляет их позиции на международной арене, открывая перед ними двери для дальнейшего профессионального роста.',
    },
    {
        slug: 'article06',
    ...
    {
        slug: 'article21',
        author: 'Иван Беревозник',
        date: '2021-09-10',
        title: 'Открыт прием заявок Global Beauty Leader 2021',
        summary: 'Открыт прием заявок от профессионалов в области бюьти на Международную Премию Global Beauty Leader 2021',
        imageUrl: ArticleImg21,
        content1: 'Международная Премия Global Beauty Leader объявила о старте приема заявок на 2021 год. Уже второй год подряд этот конкурс собирает лучших профессионалов индустрии красоты со всего мира, предоставляя им уникальную возможность продемонстрировать свои достижения и инновационные подходы. Премия, впервые состоявшаяся в 2020 году, быстро завоевала признание за поддержку выдающихся специалистов в сфере красоты и велнеса.',
        content2: 'Участие в Global Beauty Leader предоставляет уникальную возможность заявить о себе на международной арене и стать частью элиты индустрии красоты. Этот престижный конкурс собирает ведущих специалистов, которые стремятся развивать отрасль, внедряя инновационные технологии и современные подходы.',
        content3: 'В этом году премия претерпела значительные изменения, делающие ее еще более доступной и привлекательной для участников:',
        content4: 'Упрощенный процесс подачи заявок: Теперь процесс регистрации стал более удобным и прозрачным. Участники могут легко подать заявку через обновленную онлайн-платформу премии, загрузив свои работы в цифровом формате, что значительно ускоряет процесс и делает его доступным для профессионалов из разных стран.',
        content5: 'Номинации премии Global Beauty Leader 2021',
        ...
        textli7: 'Визажист года ',
        textli8: 'За вклад в развитие индустрии',
        content6: 'Международное сотрудничество: В 2021 году особое внимание уделяется международному взаимодействию между участниками и жюри. Премия становится платформой для установления новых профессиональных связей и партнерств, способствующих карьерному росту и обмену опытом.',
        content7: 'Фокус на инновации и экологичность: Особое внимание уделяется проектам и технологиям, ориентированным на устойчивое развитие и использование экологически чистых материалов и подходов. В номинациях, таких как «Инноватор года» и «За вклад в развитие индустрии», будут отмечены участники, которые активно внедряют экологичные и социально ответственные решения в свои работы.',
        content8: 'В 2021 году организаторы премии расширяют границы, ожидая еще большего числа участников. Global Beauty Leader включает восемь ключевых номинаций, каждая из которых подчеркивает важность профессионализма и инноваций в различных аспектах индустрии красоты: Инноватор Года, Лучший Мастер Эстетической Медицины, Мастер года в Ногтевой Эстетике, Прорыв Года, Мастер года в Перманентном Макияже, Парикмахер Года, Визажист Года, За Вклад в Развитие Индустрии.',
        content9: 'С десятого по двадцать пятое сентября 2021 года любой профессионал с опытом работы в сфере красоты от трех лет может подать заявку на участие, представив портфолио своих работ. Все заявки будут тщательно оценены жюри, состоящим из признанных экспертов индустрии с международным опытом. Каждый из членов жюри обладает уникальными знаниями, которые позволяют объективно оценивать работы конкурсантов по таким критериям, как новаторство, техническое мастерство и влияние на отрасль',
        content10: 'Комментарии от прошлогодних участников',
        content11: 'Лейла Гаджиева, победитель номинации «Визажист Года 2020», делится своими впечатлениями: «Участие в Global Beauty Leader дало мне возможность не только показать свои разработки, но и найти единомышленников по всему миру. Эта премия открывает двери к международным контактам и сотрудничеству, что очень важно для дальнейшего развития моей карьеры. Я с удовольствием подам заявку на участие в следующем году и сделаю все возможное чтобы получить эту премию еще раз».',
        content12: 'В прошлом году конкурс Global Beauty Leader привлек внимание широкой аудитории, включая представителей разных стран и культур. Участие в нем было не просто престижным, но и принесло победителям признание на международной арене. Мастера, представившие свои работы, смогли продемонстрировать высокий уровень профессионализма и креативности, что позволило конкурсу закрепиться как одно из главных событий в мире красоты.',
        content13: 'Участие в Global Beauty Leader является подтверждением вашего профессионализма на международной арене. Этот конкурс открывает возможности для карьерного роста, международного сотрудничества и дает шанс продемонстрировать свой талант мировому сообществу. Присоединяйтесь к Global Beauty Leader 2021, чтобы подтвердить свой статус одного из лучших специалистов в индустрии красоты!',
    ...
    },
    {
        ...
        content1: '1 октября были подведены итоги выдающегося события в мире красоты — Международной премии, организованной Сообществом Предприятий Индустрии Красоты (СПИК), проходившего с 10 сентября по 25 сентября 2020 года.',
