...
function Statute() {
  ...
  return (
    ...
    <div className="text-center">
        ...
        <p className="page-text">3.2.12. Оспаривание от имени Международной Ассоциации Красоты и Ухода (МАКУ) в установленном законодательством Российской Федерации порядке любых актов, решений и (или) действий (бездействия) органов государственной власти Российской Федерации, органов государственной власти субъектов Российской Федерации и органов местного самоуправления, нарушающих права и законные интересы Ассоциации, ее члена или членов, либо создающих угрозу такого нарушения.</p>
        ...
        <p className="page-text">3.2.15. Использование возможности фонда МАКУ для оказания помощи в приобретении профессиональных навыков малоимущим семьям.</p>
        ...
        <p className="page-text">3.2.30. Оказание консультативной и иной помощи членам МАКУ.</p>
        <p className="page-text">3.2.31. Обмен опытом и мнениями среди членов МАКУ.</p>
        <p className="page-text">3.2.32. Создание команды сборной России для участия в российских и международных конкурсах.</p>
        <p className="page-text">3.2.33. Разработка и утверждение документов МАКУ, предусмотренных законодательством Российской Федерации для саморегулируемых организаций в области индустрии красоты, а также контроль за соблюдением членами МАКУ требований этих документов.</p>
        ...
        <div id="7" ref={section7Ref} className="sub-title text-center pt-30">ПОРЯДОК ВСТУПЛЕНИЯ В ЧЛЕНЫ АССОЦИАЦИИ И ВЫХОДА ИЗ ЧЛЕНОВ АССОЦИАЦИИ</div>
        <p className="page-text">Для вступления в «Международную Ассоциацию Красоты и Ухода (International Association of Beauty and Care)» новых членов, необходимо показать выдающиеся результаты в сфере красоты и ухода. Членами Ассоциации могут быть только специалисты, которые отличаются высоким уровнем компетенции и опыта в индустрии красоты. В качестве критериев для членства в Ассоциации выступают следующие:</p>
        <p className="page-text">7.1 Профессиональные достижения: Кандидаты должны обладать выдающимися навыками и результатами работы в сфере красоты и ухода.</p>
        <p className="page-text">7.1.2. Опыт работы: Претенденты должны иметь значительный опыт (не менее 3х лет)  работы в области красоты и ухода, подтвержденный релевантным опытом или сертификатами.</p>
        <p className="page-text">7.1.3. Участие в профессиональных мероприятиях: Кандидаты должны активно участвовать в семинарах, мастер-классах и других образовательных мероприятиях, связанных с индустрией красоты.</p>
        <p className="page-text">7.1.4. Публикации и признание: Претенденты должны иметь публикации о своей профессиональной деятельности в рейтинговых изданиях или получить признание от экспертов в индустрии красоты.</p>
        <p className="page-text">7.1.5. Профессиональная этика: Кандидаты должны следовать высоким стандартам профессиональной этики и нормам поведения в сфере красоты.</p>
        <p className="page-text">Процедура вступления в члены Ассоциации осуществляется по решению Общего собрания членов на основании представленных заявлений о вступлении. После принятия решения и внесения сведений в реестр членов, кандидат считается принятым в члены «Международной Ассоциации Красоты и Ухода (International Association of Beauty and Care)» </p>
        <p className="page-text">7.2. Членство в Ассоциации прекращается в случаях:</p>
        <p className="page-text"> 7.2.1. выхода из Ассоциации; </p>
        <p className="page-text">7.2.2. исключения из Ассоциации.</p>
        <p className="page-text">7.3. Выход из Ассоциации осуществляется по заявлению члена Ассоциации. Член Ассоциации имеет право получить при выходе из Ассоциации часть его имущества или стоимость этого имущества в пределах стоимости имущества, переданного данным членом в собственность Ассоциации, за исключением членских взносов, при этом срок возврата имущества не может превышать одного года с момента подачи заявления о выходе из состава Ассоциации.</p>
        <p className="page-text">7.4. Член Ассоциации может быть исключен из него по решению остающихся членов.</p>
        <div id="8" ref={section8Ref} className="sub-title text-center pt-30">ПРАВА И ОБЯЗАННОСТИ ЧЛЕНОВ АССОЦИАЦИИ</div>
